...
<div class="download-panel">
	...
	<img src="<?php echo $sponsorship_booklet_cover['sizes']['large']; ?>" class="img-responsive">

	<span class="info-txt bold txt-col-blue-dk block text-center">For more details on our Partner and sponsorship packages download our sponsorship pack.</span>
